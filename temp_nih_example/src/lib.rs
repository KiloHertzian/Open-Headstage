...
struct GainParams {
    ...
    /// This field is not used in this example, but anything written to the vector would be restored
...
#[derive(Params)]
struct ArrayParams {
    /// This parameter's ID will get a `_1`, `_2`, and a `_3` suffix because of how it is used in
    /// `array_params` above.
    #[id = "noope"]
    pub nope: FloatParam,
}
...
impl Default for GainParams {
    fn default() -> Self {
        Self {
            ...
            // Persisted fields can be initialized like any other fields, and they will keep their
...
impl Plugin for Gain {
    ...
    type SysExMessage = ();
    // More advanced plugins can use this to run expensive background tasks. See the field is
